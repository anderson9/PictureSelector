...
public class CaptureLayout extends FrameLayout {
    ...
    public ImageView iv_custom_left;            //左边自定义按钮
...
//                resetCaptureLayout();
        ...
        //切换
        LayoutParams layoutParamsbtn_swich = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        layoutParamsbtn_swich.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        layoutParamsbtn_swich.setMargins(0, 0, (layout_width / 4) - button_size / 2, 0);
        btn_confirm.setLayoutParams(layoutParamsbtn_swich);
        //返回按钮
        ...
        LayoutParams iv_custom_param_left = new LayoutParams((int) (button_size ), (int) (button_size ));
        iv_custom_param_left.gravity = Gravity.CENTER_VERTICAL;
        iv_custom_param_left.setMargins(layout_width / 12, 0, 0, 0);
        iv_custom_left.setLayoutParams(iv_custom_param_left);
        //右边自定义按钮
        iv_custom_right = new ImageView(getContext());
        LayoutParams iv_custom_param_right = new LayoutParams((int) (button_size/2.5), (int) (button_size/2.5));
