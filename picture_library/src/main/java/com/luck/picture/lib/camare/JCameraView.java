...
import com.luck.picture.lib.camare.listener.CaptureListener;
import com.luck.picture.lib.camare.listener.ClickListener;
import com.luck.picture.lib.camare.listener.ErrorListener;
import com.luck.picture.lib.camare.listener.JCameraListener;
import com.luck.picture.lib.camare.listener.ReturnListener;
import com.luck.picture.lib.camare.listener.TypeListener;
import com.luck.picture.lib.camare.state.CameraMachine;
import com.luck.picture.lib.camare.util.FileUtil;
import com.luck.picture.lib.camare.util.LogUtil;
import com.luck.picture.lib.camare.util.ScreenUtils;
import com.luck.picture.lib.camare.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    //录制视频比特率
    public static int MEDIA_QUALITY_HIGH = (int) (4.96 * 1024 * 1024);//自定义的  大概1080的码率设置 具体由手机性能决定
    ...
    private int minduration = 5000;       //最短录制时间
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = a.getInteger(R.styleable.JCameraView_duration_max, 20 * 1000);       //没设置默认为20s
        a.recycle();
        initData();
        initView();
    }
...
//        });
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation("录制时间过短,最小5秒");
...
//        });
    ...
    public void onResume() {
        ...
        CameraInterface.getInstance().setSwitchView(mCaptureLayout.iv_custom_left);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setRturnClickClickListener(ClickListener clickListener) {
